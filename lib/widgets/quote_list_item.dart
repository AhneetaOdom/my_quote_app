...
class QuoteListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(color: Colors.purple.shade50, borderRadius: BorderRadius.circular(4.0),),
        ...
        child: Padding(
          ...
          child: ListTile(
            ...
            title: Text(quoteItem.quote,style: TextStyle(color: black,fontSize: AppSizes.fontSizeMd,fontWeight: FontWeight.w300),),

            subtitle: Text(quoteItem.author,style: TextStyle(color: Colors.black45,fontSize: AppSizes.fontSizeXs,fontWeight: AppSizes.fontWeightNormal),textAlign: TextAlign.end,),
          ),
        ),
      ),
    );
